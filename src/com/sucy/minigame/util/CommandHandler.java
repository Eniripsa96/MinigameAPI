...
public abstract class CommandHandler implements CommandExecutor {
    ...
    public void displayUsage (CommandSender sender, int page) {
        ...
        sender.sendMessage(ChatColor.DARK_GREEN + title + " - Command Usage (Page " + page + "/" + maxPage + ")");
    ...
    /**
     * <p>Registers all sub-commands</p>
     * <p>This must be overridden and should include a registerCommand(String, ICommand) call
     * for each of your commands.</p>
     */
